package master.DataStructures.Buffers;

import java.util.Random;
import java.util.concurrent.atomic.AtomicInteger;

public class CricularBuffer {
    ...
    public CricularBuffer(int buffer_size) {
    ...
    private static class TestWriteWorker implements Runnable {
        ...
        CricularBuffer _buffer;
        public TestWriteWorker(CricularBuffer cb) {
            this._buffer = cb;
        }
    ...
    private static class TestReadWorker implements Runnable {
        CricularBuffer _buffer;
        public TestReadWorker(CricularBuffer cb) {
            this._buffer = cb;
        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        CricularBuffer cb = new CricularBuffer(buffer_size);
