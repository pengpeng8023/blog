...
public class MuchThreadDown {
    ...
    private static  String path = "http://softdownload.hao123.com/hao123-soft-online-bcs/soft/Y/2013-07-18_YoudaoDict_baidu.alading.exe";
...
//          randomAccessFile.close();
    ...
    public static void main(String[] args) {
        try {
            new MuchThreadDown(MuchThreadDown.path, null, 3).download();
